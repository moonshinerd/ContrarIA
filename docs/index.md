...
Agente de mitigação de desinformação política e detecção de bots no **Bluesky**, desenvolvido para o *Challenge 1: Fake News / Desinformação* (CBL).
...
|---|---|---|
| Víctor Hugo Lima Schmidt | [@moonshinerd](https://github.com/moonshinerd) | Product Owner · dupla de código A |
| Marlon Martins Braga | [@MylinDev](https://github.com/MylinDev) | Scrum Master · dupla de código A |
| Raissa Silva | [@RaissaOliveira19](https://github.com/RaissaOliveira19) | Developer · dupla de código B |
| Samantha Yumi Tanaka | [@ySamantha](https://github.com/ySamantha) | Developer · dupla de código B |
| Kyara Esteves de Sousa | [@Kyara2](https://github.com/Kyara2) | Developer · dupla de documentação |
| Antonio Leonardo Souto Gomes | [@AntonioLeonardoUNB](https://github.com/AntonioLeonardoUNB) | Developer · dupla de documentação |
